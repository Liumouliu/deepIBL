function sessionID= trainCauchyKernelInd(dbTrain, dbVal, varargin)
opts= struct(...
    'netID', 'caffe', ...
    'layerName', 'conv5', ...
    ...
    for iBatch= 1:nBatches
        ...
        for iQuery= 1:opts.batchSize
            ...
            for nv = 3:thisNumIms
                ...
                dzdp_t = -2.0*(1-cpq(nv-2))/(1+dPos)*(feats(:,1)-feats(:,2));
                dzdn_t = 2.0*(1-cpq(nv-2))/(1+dsSq(nv-1))*(feats(:,1)-feats(:,nv));
